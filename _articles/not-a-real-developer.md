...
## 3. Mind the Data and the Context
...
But very few valuable things happen without data.

So lean into the data. Embrace the mess.

This has been my secret weapon. I'm not great at elegant code. But I'm really good at understanding messy data.

Where it comes from. Why it's inconsistent. What the business rules actually are (versus what people think they are). How to reconcile systems that were never designed to talk to each other.
...
I don't need to know design patterns anymore. Or architectural best practices. Or the right way to structure code.
...
- Decide what's good enough vs. what needs to be robust

The AI provides the patterns. The structure. The best practices.

I provide the judgment. The business context. The "yeah, but in reality..." knowledge.

This is still scrappy hacking. But now my scrappy ideas get implemented with professional-grade code structure.

I built a sales pipeline integration last month. Seven different data sources. Complex matching logic. Exception handling. Audit logs.

I described the business problem. The AI asked clarifying questions. Suggested architectural approaches. I picked the one that matched our actual needs (not the most elegant one).

It implemented it. Clean code. Good structure. Production-ready.
...
Scrappy. But with AI providing the professional implementation.

That's the new game. I bring the business knowledge and scrappy experimental mindset. AI brings the technical chops.

Neither of us could do it alone. Together, we ship.

---

## 5. Agentic AI Wants To Be Pointed, Not Programmed
...
But that's not how you work with agentic AI.

You point. You describe the outcome. You provide context. Then you let it explore.
...
Then you adjust. Iterate. Learn together.
...
Let the AI explore. Let it reason. Let it make choices.
...
This wouldn't work with old AI. You needed to be precise or you'd get garbage.
...
## 6. Multi-Agent Workflows: Scrappy Just Got Scalable

Here's the newest pattern I'm experimenting with:

Multiple AI agents working in parallel. Each one tackling a piece of a complex problem. Coordinating through shared context in the IDE.
...
I'm cycling between them. Nudging each forward. Checking their reasoning. Adjusting direction.
...
The agents maintain their own context. Remember their own progress. Make decisions within their scope.

I'm the conductor. Not playing every instrument. Just keeping the orchestra in sync.

Last week, I built a complex reporting system this way. Four agents. Different aspects of the problem. Running in parallel IDE windows.

Research and planning agent: exploring the data sources, documenting patterns.

Data pipeline agent: building the ETL logic.

Visualization agent: creating the dashboard.

Testing agent: validating edge cases.

Me: cycling between them, checking in every 20-30 minutes, making strategic decisions, testing the integrations.

Five days. Working system. Production-deployed.

Would a real developer team do it this way? Probably not. They'd have formal handoffs. Coordinated sprints. Integration meetings.

But this worked. This shipped. This created value.

It's scrappy hacking scaled up. Multiple collaborators (AI agents). Loose coordination. Fast iteration. Ship and learn.

The breakthrough isn't the technology. It's realizing that the scrappy mindset works at scale now.

You don't need to become a "real developer." You need to become a good conductor.

Point multiple AIs in the right direction. Let them work semi-autonomously. Check in to coordinate. Make judgment calls. Ship fast.

That's the future of scrappy hacking. And honestly, it feels like where business technology was always heading.

Not perfect. Not architecturally pure. But fast, adaptive, and valuable.

---

## What This Means for Business Technology

I spent 15 years feeling like a second-class citizen in the technology world.

Real developers had computer science degrees. I had a business background and learned to hack.

Real developers built architecturally sound systems. I built scrappy solutions that worked.

Real developers got respect. I got "well, that's not really development."

But here's what I learned:

**For most business problems, scrappy beats perfect.**

Not because perfect isn't better. Because perfect takes too long. Costs too much. Can't adapt fast enough.

Business moves faster than enterprise IT. Always has. Always will.

The scrappy hackers who could build fast, adapt quickly, and ship constantly? We've been creating the majority of actual business value.

We just didn't get credit for it.

November 2025 changes the equation.

Now scrappy hackers can build at scrappy speed with professional-grade implementation.

We can experiment fast and ship production systems.

We can point AI agents and coordinate complex work.

We can embrace the mess of real data and build solutions that work in reality, not just in theory.

The real developers will adapt. They'll learn to work with AI. They'll bring architectural thinking to bigger problems.

But the scrappy hackers? This is our moment.

We've always known how to:
- Ship fast and iterate
- Embrace imperfection
- Work with messy reality
- Create value over elegance
- Experiment and learn

Now we have AI that handles the technical implementation. That knows the patterns. That writes clean code.
...
If you've spent years feeling like you're not technical enough. Not a "real" developer. Just hacking things together.

Good. That's exactly the mindset you need for November 2025.

Don't try to become a real developer. Double down on being a scrappy hacker.

Learn to:
- Point AI agents toward outcomes
- Coordinate multiple AI collaborators
...
Not "real development." Not "AI does everything."
...
## The Scrappy Hacker's Moment

I've been "not a real developer" for 15 years.

Built more value than I can count. Automated thousands of hours of manual work. Created systems that generated millions in revenue.
...
It's a legitimate strategy for business technology. Especially now.

Fast beats perfect. Adaptive beats planned. Good enough beats architected-for-the-future.

When you have AI handling the technical implementation? Scrappy becomes a superpower.

So if you're not a real developer? Join me.

Let's build scrappy, ship fast, iterate constantly, and create ridiculous amounts of value.

The real developers can keep debating architecture patterns.

We'll be shipping.

---

**Want to learn scrappy hacking with AI?**

Let's build something real together. Your business problem. Scrappy approach. AI implementation. Production results.
...
## P.S. To Real Developers Reading This

I'm not actually against you. Some of my best friends are real developers.

You bring value that scrappy hackers can't. Architectural thinking for true enterprise systems. Performance optimization at scale. Security expertise. Deep algorithmic knowledge.

But here's the thing:

Most business problems don't need that. They need fast, adaptive solutions that work in messy reality.

And increasingly, AI can provide the architectural patterns while business experts provide the judgment.

You'll adapt. You'll find your place in this new world. Probably doing even more interesting work than you do now.

But the scrappy hackers are going to build a lot more stuff. A lot faster.

Not because we're better. Because we've been training for this mindset our whole careers.

No hard feelings. See you in production.